/**
 * TypeScript bindings for Aureva Rewards Soroban smart contracts.
...
export interface AurevaTokenClient {
...
export interface aurevaRewardsClient {
  initialize(admin: Address, aureva_token: Address, event_config: EventConfig): Promise<void>;
  ...
  get_aureva_token(): Promise<Address>;
