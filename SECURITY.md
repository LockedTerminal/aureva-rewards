...
Aureva Rewards welcomes responsible disclosure of security vulnerabilities that could affect the platform, its smart contracts, backend services, APIs, or supporting infrastructure.
...
- Primary contact: `security@aurevaRewards.example`
...
- Backend APIs and services under `backend/` and `aurevaRewards/backend/`
- Frontend application code under `src/`, `frontend/`, and `aurevaRewards/frontend/`
...
- Issues in third-party services outside Aureva Rewards control
...
Aureva Rewards follows a coordinated disclosure process with a target timeline of up to 90 days:
...
If you act in good faith, avoid privacy violations and service disruption, and give us reasonable time to respond before public disclosure, Aureva Rewards will treat your research as authorized.
...
Aureva Rewards operates a public bug bounty program to reward security researchers who responsibly disclose vulnerabilities.

### Program Listings

| Platform | URL | Status |
| --- | --- | --- |
| Immunefi | https://immunefi.com/bug-bounty/aureva-rewards | Active |
| HackerOne | https://hackerone.com/aureva-rewards | Active |

Submissions made through either platform are triaged under the same policy and reward tiers defined in this document. Direct email reports to `security@aurevaRewards.example` are also accepted and treated equivalently.
...
- Employees, contractors, and immediate family members of Aureva Rewards are not eligible.

### Reward Payment

Rewards are paid in USDC or AUR tokens at the reporter's preference, within 30 days of patch release. Reward amounts are determined at Aureva Rewards' sole discretion based on severity, exploitability, and report quality.
