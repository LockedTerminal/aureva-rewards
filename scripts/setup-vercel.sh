...
# aureva-rewards Vercel Setup Script
# This script helps configure Vercel deployment for the aureva-rewards frontend
# Usage: bash scripts/setup-vercel.sh

set -e

echo "🚀 aureva-rewards Vercel Setup"
echo "=============================="
echo ""
...
echo "  3. Configure the root directory to: aurevaRewards/frontend"
echo ""
read -p "Press Enter to continue..."

vercel link --cwd aurevaRewards/frontend
...
echo "  NEXT_PUBLIC_API_URL=https://api-preview.aureva-rewards.xyz"
...
echo "  NEXT_PUBLIC_API_URL=https://api.aureva-rewards.xyz"
...
echo "  2. Add domain: app.aureva-rewards.xyz"
...
echo "  3. Test custom domain: https://app.aureva-rewards.xyz"
