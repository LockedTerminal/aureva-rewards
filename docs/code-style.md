...
This document defines the coding standards for Aureva Rewards. Consistent style keeps the codebase readable and maintainable for everyone.
...
- ESLint config lives in `AurevaRewards/backend/.eslintrc.js`.
