# Aureva Rewards — Product Requirements Document
...
Aureva Rewards solves these problems by leveraging blockchain transparency, smart contract automation, and Stellar's fast, low-cost infrastructure to create a loyalty ecosystem where rewards are truly owned, freely transferable, and verifiably fair.
...
| **Points Issued per Day** | 50,000 AUR | 200,000 AUR |
...
- **AUR token Contract** — Stellar-based asset issuance with mint/burn/transfer capabilities
...
- **Trustline Management** — Automated trustline creation for AUR asset
- **Balance Display** — Real-time AUR balance and transaction history
- **Peer-to-Peer Transfer** — User-to-user AUR token transfers
...
#### 6. Cross-Asset Swaps
- **DEX Integration** — Multi-hop swap routing for AUR → XLM conversion
...
#### 10. Staking & Yield
- **AUR Staking Pools** — Lock tokens for yield generation
...
|----------|---------|---------------|-----------|
| **Must Have** | AUR token Contract | — | Alpha |
...
1. **Fiat Payment Processing** — Merchants handle fiat transactions independently; Aureva Rewards focuses on reward layer only
...
8. **Credit/Lending Features** — No borrowing against AUR balances in V1
...
- `aureva_token` — ERC-20-style token with mint/burn
...
- `aureva-rewards` — Core rewards logic with swap integration
