...
|---|---|
| [aureva_token](#aureva_token) | Fungible AUR token (mint, burn, transfer, allowance) |
| [aureva_rewards](#aureva_rewards) | Core contract: staking, swaps, recovery |
...
| `stake` | `user: Address, amount: i128` | — | Stake AUR for yield. |
...
```bash
# From repo root
npm install packages/AUR-contracts-sdk
```

Usage:

```typescript
import type { AurevaTokenClient, CampaignClient, i128 } from '@aureva-rewards/contracts-sdk';
import { ContractErrors, getErrorMessage } from '@aureva-rewards/contracts-sdk';
...
Full type definitions: [`packages/AUR-contracts-sdk/src/index.ts`](../packages/AUR-contracts-sdk/src/index.ts)
