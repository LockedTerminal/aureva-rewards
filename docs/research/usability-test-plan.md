# Usability Testing Plan — Aureva Rewards
...
**Task:** "Sign up for Aureva Rewards and connect your wallet."
...
**Task:** "Find a campaign and earn your first AUR tokens."
...
2. Would you use Aureva Rewards for your purchases? (Yes / Maybe / No)
