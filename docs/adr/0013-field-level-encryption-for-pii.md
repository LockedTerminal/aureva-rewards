...
Aureva Rewards stores personally identifiable information (PII) — user email
...
- Code: `AurevaRewards/backend/lib/encryption.js`
- Code: `AurevaRewards/backend/middleware/validateEnv.js` (`FIELD_ENCRYPTION_KEY`)
- Code: `AurevaRewards/backend/db/userRepository.js`
- Code: `AurevaRewards/backend/db/webhookRepository.js`
