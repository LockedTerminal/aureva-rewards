...
Aureva Rewards exposes several list endpoints — transactions, reward history,
...
- Code: `AurevaRewards/backend/config/constants.js` (`MAX_PAGE_SIZE`, `DEFAULT_PAGE_SIZE`)
- Code: `AurevaRewards/backend/routes/transactions.js`
- Code: `AurevaRewards/backend/routes/rewards.js`
- Code: `AurevaRewards/backend/db/transactionRepository.js`
- Code: `AurevaRewards/frontend/pages/rewards.js` (infinite scroll consumer)
