...
Aureva Rewards supports user wallet flows, merchant campaign management, admin
...
- `AurevaRewards/frontend` provides the Next.js PWA, wallet UI, API clients,
  contexts, and user-facing state.
- `AurevaRewards/backend` provides the Express API, route-level authorization,
...
- Code: `AurevaRewards/frontend/lib/api.js`
- Code: `AurevaRewards/backend/server.js`
- Code: `deployment/nginx/nginx.conf`
- Code: `helm/aureva-rewards/templates/ingress.yaml`
