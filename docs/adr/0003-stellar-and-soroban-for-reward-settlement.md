...
Aureva Rewards is a tokenized loyalty platform. Reward transfers must be
...
- `AurevaRewards/blockchain/trustline.js` verifies recipient trustlines before
  transfer attempts.
- `AurevaRewards/backend/services/sorobanService.js` invokes configured Soroban
...
- Code: `AurevaRewards/blockchain/sendRewards.js`
- Code: `AurevaRewards/blockchain/trustline.js`
- Code: `AurevaRewards/backend/services/sorobanService.js`
- Code: `AurevaRewards/backend/services/contractEventService.js`
