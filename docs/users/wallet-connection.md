# Wallet Connection — Aureva Rewards

This document explains how to connect a wallet to the Aureva Rewards web app and common troubleshooting steps.
...
1. Open the Aureva Rewards web app and click the `Connect Wallet` button in the top-right corner.
...
- Ensure your wallet is set to the correct network (mainnet, testnet, or a custom RPC) that the Aureva Rewards deployment uses.
...
- Never share your private keys or seed phrase. Aureva Rewards will never ask for them.
