# AurevaRewards API Versioning

AurevaRewards uses URL versioning for public API stability.
...
AurevaRewards will keep the legacy `/api` alias available until `2027-01-01`. Before removing or changing a version, the API should:
