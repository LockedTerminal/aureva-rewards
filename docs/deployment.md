...
| --- | --- | --- | --- |
| 1 | `aureva_token` | `aureva_token_CONTRACT_ID` | `admin` |
...
- The separate `contracts/aureva-rewards` crate is not part of that workspace and must be built and deployed independently.
