...
Reusable test data factories for all Aureva Rewards domain entities, built with [fishery](https://github.com/thoughtbot/fishery) and [@faker-js/faker](https://fakerjs.dev/).

**Location:** `AurevaRewards/backend/tests/fixtures/factories.js`
