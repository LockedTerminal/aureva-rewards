# Landing Page Wireframes — Aureva Rewards

> Issue: [#433](https://github.com/milah-247/aureva-rewards/issues/433)  
...
Low-fidelity wireframes for the Aureva Rewards marketing / introduction page. The page is structured into four sections: **Hero**, **Features Grid**, **Tokenomics**, and **Call-to-Action**.
...
│                                            │  [AUR token │    │
│   Earn, hold, and redeem AUR tokens       │   Icon/Anim] │    │
...
│         Join thousands of users already on Aureva Rewards.        │
│                                                                 │
│              [ Create Free Account ]                            │
│                                                                 │
...
- Component implementation should live in `AurevaRewards/frontend/pages/index.js` (or `pages/landing.js`).
