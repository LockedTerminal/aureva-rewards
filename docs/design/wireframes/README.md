# Wireframes Index — Aureva Rewards

This directory contains all low-fidelity wireframes for the Aureva Rewards platform.
...
### Landing Page
The public marketing page that introduces Aureva Rewards to new visitors. Covers:
...
- [`AurevaRewards/frontend/styles/tokens.css`](../../AurevaRewards/frontend/styles/tokens.css) — CSS custom properties
- [`AurevaRewards/frontend/tailwind.config.ts`](../../AurevaRewards/frontend/tailwind.config.ts) — Tailwind configuration
