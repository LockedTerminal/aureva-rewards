# Empty States Design Guide — Aureva Rewards
...
Browse partner campaigns to start earning AUR tokens.
[Browse Campaigns →]
```
...
[🕐 Clock illustration]
No activity yet
Earn or redeem AUR tokens to see your transaction history here.
[Start Earning →]
```
