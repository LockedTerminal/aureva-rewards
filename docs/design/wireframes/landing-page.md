# Landing Page Wireframe — Aureva Rewards
...
This document provides low-fidelity wireframes for the Aureva Rewards marketing landing page. The page introduces the blockchain loyalty platform, highlights key features, explains tokenomics, and drives sign-up conversions.
...
┌────────────────────────────────────────────────────────────────────────────┐
│  NAVBAR                                                                     │
│  [Logo] Aureva Rewards         Features  Tokenomics  Docs    [Connect Wallet]│
└────────────────────────────────────────────────────────────────────────────┘
...
│                                                                             │
│              ╔═══════════════════════════════════════╗                      │
│              ║    [AUR token Icon - 120x120px]     ║                      │
│              ╚═══════════════════════════════════════╝                      │
│                                                                             │
│                  Earn. Stake. Redeem. Own Your Rewards.                    │
│                          [H1 - 48px, bold]                                 │
│                                                                             │
│         Transform loyalty into crypto. Earn AUR tokens with every         │
...
│                              FOOTER                                         │
│                                                                             │
│  [Logo] Aureva Rewards                          Connect:  𝕏  Discord  GitHub │
│                                                                             │
...
│                                                                             │
│  © 2026 Aureva Rewards. Built on Stellar.                                   │
└────────────────────────────────────────────────────────────────────────────┘
```
...
3. **Asset Creation:** Design AUR token icon, feature illustrations
