# Animation System — Aureva Rewards
...
See `AurevaRewards/frontend/styles/animations.css` for all `@keyframes` and utility classes.  
See `AurevaRewards/frontend/hooks/useReducedMotion.js` for the React hook.
