# Design Tokens Reference — Aureva Rewards

**Version:** 1.0  
**Source of Truth:** `AurevaRewards/frontend/tailwind.config.ts` + `styles/tokens.css`  
**Last Updated:** 2026-07-23

Design tokens are the atomic values of the Aureva Rewards design system. Every color, spacing value, font size, and animation duration is defined here. Use these tokens—never hardcode values.
