# Component Library — Aureva Rewards Design System

**Version:** 1.0  
**Framework:** React + Tailwind CSS  
**Last Updated:** 2026-07-23

All components live in `AurevaRewards/frontend/components/ui/`. Each component uses Tailwind CSS utility classes and references design tokens from `tailwind.config.ts`.
