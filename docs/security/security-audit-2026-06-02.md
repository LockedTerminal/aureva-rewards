...
**File:** `AurevaRewards/backend/db/userRepository.js`  
...
**File:** `AurevaRewards/backend/routes/users.js` — `POST /api/users/:id/profile-picture`  
