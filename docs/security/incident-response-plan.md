# Aureva Rewards — Incident Response Plan
...
This plan defines how the Aureva Rewards team detects, responds to, and recovers from security incidents. Given the on-chain nature of the platform, some incidents (e.g., token theft) may be irreversible, making rapid detection and containment the top priority.
...
- What Aureva Rewards is doing to fix it

**Public status page:** Update status.AurevaRewards.io for any service degradation.
