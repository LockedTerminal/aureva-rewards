...
This document identifies threats to the Aureva Rewards platform across its three layers: Soroban smart contracts on Stellar, the Node.js backend API, and the Next.js frontend. It follows the STRIDE methodology and maps threats to mitigations.
