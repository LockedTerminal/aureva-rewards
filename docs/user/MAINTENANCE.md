...
This document defines the process for keeping `docs/user/faq.md` accurate and up to date as the Aureva Rewards platform evolves.
...
- [ ] **Staking rate** — confirm the annual rate shown in FAQ #17 matches the current `AnnualRate` stored in the `AurevaRewardsContract`.
...
|------|---------------|--------|
| 2026-03-30 | Initial FAQ created (25 Q&As, 4 sections) | Aureva Rewards Team |
