# Contributing to Aureva Rewards
...
2. **Clone** your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/aureva-rewards.git
   cd aureva-rewards
   ```

3. **Add the upstream remote** so you can pull in future changes:
   ```bash
   git remote add upstream https://github.com/Emoji-dot/aureva-rewards.git
   ```

4. **Verify your remotes**:
   ```bash
   git remote -v
   # origin    https://github.com/YOUR_USERNAME/aureva-rewards.git (fetch)
   # upstream  https://github.com/Emoji-dot/aureva-rewards.git (fetch)
   ```
...
If any step fails, check the [troubleshooting section in the README](./aurevaRewards/QUICK_START_PWA.md) or open a discussion.
...
- **Questions about the codebase?** Open a [GitHub Discussion](https://github.com/Emoji-dot/aureva-rewards/discussions).
- **Found a security vulnerability?** See [docs/security/README.md](docs/security/README.md) — do **not** open a public issue.
- **Stuck on setup?** Check [aurevaRewards/QUICK_START_PWA.md](aurevaRewards/QUICK_START_PWA.md) or ask in Discussions.
