...
const SIGNATURE_HEADER    = 'x-AUR-signature';
const TIMESTAMP_HEADER    = 'x-AUR-timestamp';
const DELIVERY_ID_HEADER  = 'x-AUR-delivery-id';
 ...
 *
 * @param {string} secret
 * @param {string} receivedSig   - value of x-AUR-signature header
 * @param {string} timestamp     - value of x-AUR-timestamp header
 * @param {string} deliveryId    - value of x-AUR-delivery-id header
  ...
  return new Promise((resolve, reject) => {
    ...
    const options = {
      ...
      headers: {
        ...
        'User-Agent':          'aurevaRewards-Webhook/1.0',
      },
    };
