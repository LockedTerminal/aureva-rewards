...
## Overview
The health check endpoints provide monitoring capabilities for the AurevaRewards backend system, allowing you to verify the status of all critical components.
