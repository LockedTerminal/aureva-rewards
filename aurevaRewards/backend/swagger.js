...
const options = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'aurevaRewards API',
      version: '1.0.0',
      description:
        'REST API for the Aureva Rewards blockchain loyalty platform. ' +
      ...
      contact: { name: 'Aureva Rewards Team' },
      license: { name: 'MIT' },
    },
    servers: [
      { url: 'http://localhost:3001/api/v1', description: 'Local development (current v1)' },
      { url: 'https://api.aurevaRewards.io/api/v1', description: 'Production (current v1)' },
      { url: 'http://localhost:3001/api', description: 'Local development legacy alias for v1' },
      { url: 'https://api.aurevaRewards.io/api', description: 'Production legacy alias for v1' },
    ],
    components: {
      securitySchemes: {
        bearerAuth: {
