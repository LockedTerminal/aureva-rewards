#!/usr/bin/env node
/**
 * aurevaRewards Testnet Setup Script
 *
 * Generates fresh Issuer and Distribution keypairs (or uses existing ones from .env),
 * funds them via Friendbot, issues the AUR asset, and prints all account details.
 *
 * Usage:
...
async function main() {
  ...
  console.log('\n=== Setup Complete ===');
  console.log('Your aurevaRewards platform is ready on Stellar Testnet.');
  console.log(`AUR asset issuer: ${issuerKeypair.publicKey()}`);
