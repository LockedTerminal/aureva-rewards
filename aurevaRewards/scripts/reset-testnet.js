#!/usr/bin/env node
/**
 * aurevaRewards Testnet Reset Script
 *
 * Re-funds the Issuer and Distribution accounts via Friendbot and
 * re-issues the initial AUR supply. Useful for resetting Testnet
...
async function main() {
  ...
  console.log('=== aurevaRewards Testnet Reset ===');
