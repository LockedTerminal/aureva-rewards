...
This guide explains how to configure and use the Progressive Web App features in Aureva Rewards.
...
VAPID_EMAIL=admin@AurevaRewards.com
NEXT_PUBLIC_VAPID_PUBLIC_KEY=your-generated-public-key
```

### 2. Create App Icons

Place app icons in `AurevaRewards/frontend/public/icons/`:
