// @ts-check
/**
 * Shared test helpers and fixtures for Aureva Rewards E2E tests.
 */
...
function uniqueEmail(prefix = 'user') {
  return `${prefix}+${Date.now()}@test.AUR`;
}
 ...
 * @param {string} options.balance - AUR balance (default: '1000.0000000')
