...
This directory contains end-to-end (E2E) tests for the Aureva Rewards reward issuance flow, covering the complete critical user journey from merchant registration to on-chain balance confirmation.
...
# Backend
DATABASE_URL=postgresql://postgres:password@localhost:5432/aureva_rewards_test
...
```
✅ Test merchant created: merchant-1234567890@test.aureva-rewards.com
   Merchant ID: 1
...
- [Aureva Rewards Architecture](../../docs/)
