/**
 * Single source of truth for formatting AUR token amounts across all components.
 * 
...
/**
 * Formats a raw or string AUR token amount into a standard, locale-aware display string.
 *
