  ...
  const handleExport = async (format) => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        filename = 'aureva-rewards-data.json';
      } else {
        const csv = 'field,value\nexportedAt,' + mockData.exportedAt;
        blob = new Blob([csv], { type: 'text/csv' });
        filename = 'aureva-rewards-data.csv';
      }
    ...
    <div>
      ...
      <div className="settings-subsection">
        ...
        <p className="settings-row-desc" style={{ marginBottom: '1rem' }}>
          Download a copy of your Aureva Rewards data including your profile, transaction history, and earned rewards.
        </p>
