...
export default function OnboardingSteps({ onComplete }) {
  ...
  const steps = [
    {
      title: 'Welcome to aurevaRewards',
      description: 'Your blockchain-powered loyalty program',
      icon: (
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
      ),
      content: 'Earn AUR tokens for purchases and redeem them for rewards. All transactions are secure and transparent on the Stellar blockchain.'
    },
    {
      ...
      content: 'Freighter is a secure browser extension wallet for Stellar. Install it to safely store and manage your Aureva Rewards.'
    },
    {
      title: 'Start Earning',
      ...
      content: 'Shop at participating merchants and automatically earn AUR tokens. Track your balance and transaction history in real-time.'
    }
  ];
