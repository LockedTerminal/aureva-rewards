...
const FAQ_DATA = [
  {
    ...
    items: [
      {
        id: 'faq-1',
        question: 'What is Aureva Rewards?',
        answer:
      ...
      {
        id: 'faq-4',
        question: 'Is Aureva Rewards free to use?',
        answer:
    ...
    items: [
      {
        ...
        answer:
          'Aureva Rewards uses the Stellar network to record and transfer your reward tokens securely. Think of a Stellar wallet as a secure digital pocket that holds your tokens. We recommend the free Freighter browser extension as the easiest option.',
      },
      {
        id: 'faq-12',
        question: 'How do I connect my Stellar wallet?',
        answer:
          'Install the Freighter browser extension, create or import a wallet inside it, then click Connect Wallet on your Aureva Rewards dashboard. Freighter will ask you to approve the connection — click Approve. Your wallet address will then appear on your dashboard.',
      },
      {
        id: 'faq-13',
        question: 'What is a "trustline" and why do I need to set one up?',
        answer:
          'Before your wallet can receive AUR tokens, it needs to be told to accept them — this is called a trustline. It\'s a one-time setup. On your dashboard, click Add AUR Trustline and approve the security confirmation in Freighter. You only need to do this once.',
      },
      {
        id: 'faq-14',
        question: 'What is staking, and how does it work?',
        answer:
          'Staking means locking a portion of your AUR tokens to earn extra bonus tokens over time. Choose an amount to stake on your dashboard, confirm, and your tokens are locked. While staked, your balance grows based on the current annual reward rate. When you unstake, you receive your original tokens back plus any bonus earned.',
      },
      {
        id: 'faq-15',
      ...
      },
      {
        ...
        answer:
          'Aureva Rewards never stores your private wallet key — only you hold that through Freighter. All token transfers require your explicit approval via a security confirmation pop-up. Admin functions use multi-approval controls, and all smart contracts have been independently audited.',
      },
    ],
  },
  {
    ...
    <div className="faq-container">
      <div className="faq-header">
        ...
        <p className="faq-subtitle">
          Find answers to common questions about Aureva Rewards.
        </p>
        <input
      ...
      {filtered.length === 0 ? (
        <p className="faq-no-results">
          ...
          <a href="mailto:support@aurevaRewards.io">contact support</a>.
        </p>
      ) : (
