...
const STEPS = [
  {
    ...
    description: 'Link your Freighter wallet to start using Aureva Rewards.',
    icon: (
  ...
  {
    title: 'Earn Tokens',
    description: 'Complete qualifying actions to receive AUR tokens instantly.',
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
  ...
  },
  {
    ...
    description: 'Spend your AUR tokens on exclusive rewards and discounts.',
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
