...
const SOCIAL_LINKS = [
  {
    label: 'Twitter / X',
    href: 'https://twitter.com/aurevaRewards',
    icon: (
  ...
  {
    label: 'Discord',
    href: 'https://discord.gg/aurevaRewards',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    <footer className="site-footer">
      <div className="footer-inner">
        ...
        <div className="footer-brand">
          <span className="footer-logo">⭐ aurevaRewards</span>
      ...
      <div className="footer-bottom">
        <span>© {new Date().getFullYear()} aurevaRewards. All rights reserved.</span>
      </div>
    </footer>
  );
}
