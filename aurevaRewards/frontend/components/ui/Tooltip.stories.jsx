...
export const WithIconTrigger = () => (
  <div className="p-16 flex items-center gap-4">
    ...
    <Tooltip content="Annual percentage yield earned by staking AUR tokens. Calculated based on current pool size and emission rate." position="right">
      <button
...
export const WithStarIcon = () => (
  <div className="p-16">
    <Tooltip content="AUR token — the native loyalty currency of Aureva Rewards" position="bottom">
      <button
        aria-label="AUR token information"
