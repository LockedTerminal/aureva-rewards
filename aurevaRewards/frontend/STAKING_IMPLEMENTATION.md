...
This implementation provides a comprehensive staking interface for AUR tokens, allowing users to:
...
- [Contract Source](../../contracts/aureva-rewards/)
