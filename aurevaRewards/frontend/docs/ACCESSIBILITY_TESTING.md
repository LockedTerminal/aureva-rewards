...
This document describes the comprehensive accessibility testing strategy for Aureva Rewards, ensuring WCAG 2.1 Level AA compliance.
...
Aureva Rewards is committed to ensuring digital accessibility for people with disabilities. We continually improve the user experience for everyone and apply relevant accessibility standards.
...
We welcome feedback on the accessibility of Aureva Rewards. Please contact us if you encounter accessibility barriers:

- **Email**: accessibility@AurevaRewards.com
...
Accessibility is not a feature—it's a fundamental requirement. By following this testing guide and maintaining our commitment to accessibility, we ensure Aureva Rewards is usable by everyone, regardless of ability.
