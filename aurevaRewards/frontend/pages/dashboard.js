...
function DashboardContent() {
  ...
  return (
    <>
      <nav className="nav">
        <span className="nav-brand">⭐ aurevaRewards</span>
          ...
          <>
            <div className="dashboard-summary-grid">
              ...
              <div className="card" style={{ textAlign: "center" }}>
                ...
                <p style={{ color: "#94a3b8", fontSize: "0.85rem" }}>AUR</p>
                <button
                  className="btn btn-secondary"
                ...
                {transactions.length === 0 ? (
                  <div style={{ textAlign: "center", padding: "1rem 0" }}>
                    <p style={{ color: "#94a3b8", marginBottom: "0.75rem" }}>
                      No transactions yet. Start earning Aureva Rewards!
                    </p>
                      ...
                      <tbody>
                        {transactions.map((tx, i) => {
                          ...
                          return (
                            <tr key={tx.id || i}>
                              <td>{type}</td>
                              <td>{formatTokenAmount(amount)} AUR</td>
                              <td
                                style={{
            ...
            {/* Transfer */}
            <div className="card">
              <h2 style={{ marginBottom: "1rem" }}>Send AUR</h2>
              <TransferForm
            ...
            {/* Redeem */}
            <div className="card">
              <h2 style={{ marginBottom: "1rem" }}>Redeem AUR</h2>
              <RedeemForm
                senderPublicKey={publicKey}
                senderBalance={balance}
                onSuccess={() => refreshBalance()}
